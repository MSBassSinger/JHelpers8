// Ignore Spelling: Asc dct Descrs dtm
...
namespace Jeff.Jones.JHelpers8
{
    ...
    public static class CommonHelpers
    {
        ...
        /// <summary>
        /// Since <![CDATA[ConcurrentDictionary<>]]> has no Add function, this extension provides that for 
        /// backwards compatibility for IDictionary replacement.
        /// 
        /// This extension will add if new, or update of the key exists.
        /// </summary>
        ...
        public static Boolean IsFileText(out Encoding lngEncoding, String strFileName, Int32 lngNumCharactersToRead)
        {
            ...
            try
            {
                ...
                using (var objFileStream = File.OpenRead(strFileName))
                {
                    ...
                    {
                        lngEncoding = Encoding.UTF7;  // UTF-7 is considered obsolete, but may occur in files read.  So this remains here.
                    }
                    else
                    {
                        lngEncoding = Encoding.Default;
...
}  // END namespace Jeff.Jones.JHelpers8
