    ...
    public class CommonHelpersTest
    {
        ...
        public void GetExceptionInfoTest()
        {
            ...
            catch (Exception exUnhandled)
            {
                ...
                Assert.IsTrue(logMessage == "Exception=[Topmost exception message]; Source=[JHelpers8Test]::Exception=[Inner exception message]", "Failed to match messages.");
                ...
                Assert.IsTrue(stackTraceDescrs == @"[at JHelpers8Test.CommonHelpersTest.GetExceptionInfoTest() in C:\Projects\JHelpers8\JHelpers8Test\CommonHelpersTest.cs:line 465]", "Failed to gt stack trace descriptions");
        ...
        /// </summary>
        [TestMethod]
        [DataRow(@"C:\Projects\JHelpers8\JHelpers8\License.txt")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow(@"C:\Projects\JHelpers8\JHelpers8\bin\Debug\net6.0\Output.txt")]
